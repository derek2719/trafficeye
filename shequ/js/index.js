 (function(window) {
        ...
        createTimelineHtml : function(data) {
            ...
            if (data && data.publish_id) {
                ...
                if(data.praiseList && data.praiseList.length > 0){
                   var praiseavatorhtml = me.getPraiseAvatorHtml(data.praiseList);
                   htmls.push(praiseavatorhtml);
                }
    ...
    PageManager.prototype = {
        ...
        initEvents : function() {
            ...
            //修改头像按钮
            //headimgbtnElem.onbind("touchstart",me.btnDown,headimgbtnElem);
    ...
    $(function(){
        ...
        window.initPageManager = function(uid, pid,width,height,source) {
            //把来源信息存储到本地
             var fromSource = {"source" : source,"prepage" : "index.html"}
        ...
        //window.initPageManager(39047, 'F232FFB6-FDD4-4949-8ABD-D8AF63DCBE9D');
         // window.initPageManager(38024, 'A000004936C330');
    }); 
