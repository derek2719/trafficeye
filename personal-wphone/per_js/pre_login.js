 (function(window) {
    ...
    PageManager.prototype = {
        ...
        loginSina : function(evt) {
            ...
            setTimeout((function(){
                ...
                if (Trafficeye.mobilePlatform.android) {
                    ...
                    window.external.notify("getSNSUserInfo?info=sinaweibo");
                } else {
        ...
        loginQQWeibo : function(evt) {
            ...
            setTimeout((function(){
                ...
                if (Trafficeye.mobilePlatform.android) {
                    ...
                    window.external.notify("getSNSUserInfo?info=qqweibo");
                } else {
                    alert("调用本地getSNSUserInfo方法,PC不支持.");
                }
            }),Trafficeye.MaskTimeOut);          
        ...
        loginQq : function(evt) {
            ...
            setTimeout((function(){
                ...
                if (Trafficeye.mobilePlatform.android) {
                    ...
                    window.external.notify("getSNSUserInfo?info=qzone");
                } else {
                    alert("调用本地getSNSUserInfo方法,PC不支持.");
                }
            }),Trafficeye.MaskTimeOut);     
        ...
        loginRegister : function(evt) {
            ...
            setTimeout((function(){
                ...
                // window.location.href = "pre_register.html";
            }),Trafficeye.MaskTimeOut);     
        }
    };
    ...
    $(function(){
        ...
        // 自动登录成功通知js
        callbackAutoLoginDone = function(data){
            Trafficeye.httpTip.closed();
        ...
        // 获取SNS平台用户信息，回调函数
        callbackGetSNSUserInfo  = function(data){
            // console.log(data);
            Trafficeye.httpTip.closed();
      ...
      window.initPageManager();
        // window.callbackInitPage({"isLogin":0,"dataClient":"","isEdit":0,"ua":"NOKIA RM-822_apac_prc_204,WindowsPhone,WindowsPhone8.0.10211.0,1.0.0.0,WindowsPhone_2.0.0","pid":"F9F0F18B7E3D2020702278712A9EC304BF9BE4E3","param":"","baseinfoflag":""});
